...
/// </summary>
/// <typeparam name="TDto">Тип DTO для операций чтения (Get-запросов)</typeparam>
/// <typeparam name="TCreateUpdateDto">Тип DTO для операций создания и обновления (Post/Put-запросов)</typeparam>
/// <typeparam name="TKey">Тип идентификатора DTO (например, int, Guid)</typeparam>
